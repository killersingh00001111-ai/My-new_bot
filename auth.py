...
def login():
    ...
    if request.method == "POST":
        ...
        if user and user.must_set_password:
            # This account doesn't have a real password yet (brand new,
            # or just reactivated) - this login attempt IS the "create
            # your password" step, using the same single password field
            # instead of checking it against anything already stored.
            ...
            if len(password) < 8:
                flash(
                    "This is your first login - choose a password to set "
